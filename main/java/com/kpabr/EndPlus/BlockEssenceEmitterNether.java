...
public class BlockEssenceEmitterNether extends Block{
    IIcon side;
    int axis;
    
    public BlockEssenceEmitterNether() {
    ...
    public void func_149675_a(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_, boolean reverse)
    {
        ...
        if(p_149695_1_.isBlockIndirectlyGettingPowered(p_149695_2_, p_149695_3_, p_149695_4_))
        {
            ...
            while((p_149695_1_.getBlock(p_149695_2_+dx*n, p_149695_3_+dy*n, p_149695_4_+dz*n) == Blocks.air || p_149695_1_.getBlock(p_149695_2_+dx*n, p_149695_3_+dy*n, p_149695_4_+dz*n) == Blocks.tallgrass || p_149695_1_.getBlock(p_149695_2_+dx*n, p_149695_3_+dy*n, p_149695_4_+dz*n) == EndPlus.blocks.essenceNether) && n<1024)
            {
                //System.out.println(p_149695_1_.getBlock(p_149695_2_, p_149695_3_, p_149695_4_));
                //if(!(dx == 255 && dy == 255 && dz == 255))
                //{
                //System.out.println(n);
                p_149695_1_.setBlock(p_149695_2_+dx*n, p_149695_3_+dy*n, p_149695_4_+dz*n, EndPlus.blocks.essenceNether, level, 2);
                //}
                n++;
            }
        ...
        else
        {
            ...
            while(p_149695_1_.getBlock(p_149695_2_+dx*n, p_149695_3_+dy*n, p_149695_4_+dz*n) == EndPlus.blocks.essenceNether  && n<1024)
            {
                //System.out.println(p_149695_1_.getBlock(p_149695_2_, p_149695_3_, p_149695_4_));
                //if(!(dx == 255 && dy == 255 && dz == 255))
                //{
            	if(n == 1)
            	{
            	if(p_149695_1_.getBlock(p_149695_2_+dx-1, p_149695_3_+dy, p_149695_4_+dz) == EndPlus.blocks.essenceEmitterNether)
            	{
            	...
            	if(p_149695_1_.getBlock(p_149695_2_+dx, p_149695_3_+dy-1, p_149695_4_+dz) == EndPlus.blocks.essenceEmitterNether)
            	{
            	...
            	if(p_149695_1_.getBlock(p_149695_2_+dx, p_149695_3_+dy, p_149695_4_+dz-1) == EndPlus.blocks.essenceEmitterNether)
            	{
    ...
    public void onBlockPreDestroy(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, int p_149749_5_)
    {
        ...
        if(p_149749_1_.getBlock(p_149749_2_+dx, p_149749_3_+dy, p_149749_4_+dz) == EndPlus.blocks.essenceNether)
        {
        ...
        while(p_149749_1_.getBlock(p_149749_2_+dx*n, p_149749_3_+dy*n, p_149749_4_+dz*n) == EndPlus.blocks.essenceNether && n<1024)
        {
            //System.out.println(p_149749_1_.getBlock(p_149749_2_+dx*n, p_149749_3_+dy*n, p_149749_4_+dz*n));
