 ...
 */
public class BlockEmittedEssenceEnder extends Block {

    public BlockEmittedEssenceEnder() {
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
    {
        ...
        for (int var6 = 0; var6 < 20; ++var6)
        {
            ...
            p_149734_1_.spawnParticle("reddust", var7, var9, var11, -0.75, 0.75, 1);
        }
    }
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        if(!(b1 == EndPlus.blocks.essenceEnder || b2 == EndPlus.blocks.essenceEnder || b3 == EndPlus.blocks.essenceEnder ||  b4 == EndPlus.blocks.essenceEnder ||  b5 == EndPlus.blocks.essenceEnder ||  b6 == EndPlus.blocks.essenceEnder))
        {
            if(!(b1 == EndPlus.blocks.essenceEmitterEnder || b2 == EndPlus.blocks.essenceEmitterEnder || b3 == EndPlus.blocks.essenceEmitterEnder ||  b4 == EndPlus.blocks.essenceEmitterEnder ||  b5 == EndPlus.blocks.essenceEmitterEnder ||  b6 == EndPlus.blocks.essenceEmitterEnder))
            {
