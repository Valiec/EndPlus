 ...
 */
public class BlockEmittedEssenceOverworld extends Block {

    public BlockEmittedEssenceOverworld() {
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
    {
        ...
        for (int var6 = 0; var6 < 20; ++var6)
        {
            ...
            p_149734_1_.spawnParticle("reddust", var7, var9, var11, -1, 1, 0);
        }
    }
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        if(!(b1 == EndPlus.blocks.essenceOverworld || b2 == EndPlus.blocks.essenceOverworld || b3 == EndPlus.blocks.essenceOverworld ||  b4 == EndPlus.blocks.essenceOverworld ||  b5 == EndPlus.blocks.essenceOverworld ||  b6 == EndPlus.blocks.essenceOverworld))
        {
            if(!(b1 == EndPlus.blocks.essenceEmitterOverworld || b2 == EndPlus.blocks.essenceEmitterOverworld || b3 == EndPlus.blocks.essenceEmitterOverworld ||  b4 == EndPlus.blocks.essenceEmitterOverworld ||  b5 == EndPlus.blocks.essenceEmitterOverworld ||  b6 == EndPlus.blocks.essenceEmitterOverworld))
            {
