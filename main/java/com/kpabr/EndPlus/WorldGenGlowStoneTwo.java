...
public class WorldGenGlowStoneTwo extends WorldGenerator
{
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        else if (par1World.getBlock(par3, par4 + 1, par5) == Blocks.air || par1World.getBlock(par3, par4 + 1, par5) == Blocks.glowstone)
        {
           return false;
        }
        else
