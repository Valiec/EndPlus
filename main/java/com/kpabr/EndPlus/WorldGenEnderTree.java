...
public class WorldGenEnderTree extends WorldGenTrees {
    ...
    {
        this(par1, 4, Blocks.log, Blocks.leaves, false);
    }

    public WorldGenEnderTree(boolean par1, int par2, Block par3, Block par4, boolean par5)
    {
        super(par1);
                ...
                if (par4 < 256 - l - 1)
                {
                        ...
                        for (i2 = par3 - l1; i2 <= par3 + l1; ++i2)
                        {
                            ...
                            for (int k2 = par5 - l1; k2 <= par5 + l1; ++k2)
                            {
                                ...
                                if (Math.abs(j2) != l1 || Math.abs(l2) != l1 || par2Random.nextInt(2) != 0 && i3 != 0)
                                {
                                    ...
                                    //{
                                        this.setBlockAndNotifyAdequately(par1World, i2, k1, k2, this.blockLeaves, 0);
                    ...
                    for (k1 = 0; k1 < l; ++k1)
                    {
                       ...
                       // if (block.isAir(par1World, par3, par4 + k1, par5) || block.isLeaves(par1World, par3, par4 + k1, par5))
                        //{
                            this.setBlockAndNotifyAdequately(par1World, par3, par4 + k1, par5, this.blockWood, 0);
                        //}
                    }
