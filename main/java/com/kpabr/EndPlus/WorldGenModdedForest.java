...
public class WorldGenModdedForest extends WorldGenModdedTree
{
    private boolean field_150531_a;
    private static final String __OBFID = "CL_00000401";

    public WorldGenModdedForest(boolean p_i45449_1_, boolean p_i45449_2_)
    {
        super(p_i45449_1_);
    ...
    public boolean generate(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
    {
        ...
        if (p_76484_4_ >= 1 && p_76484_4_ + l + 1 <= 256)
        {
            ...
            for (int i1 = p_76484_4_; i1 <= p_76484_4_ + 1 + l; ++i1)
            {
                ...
                Block blockb = p_76484_1_.getBlock(p_76484_3_, p_76484_4_, p_76484_5_);
                
                //boolean isSoil = block2.canSustainPlant(p_76484_1_, p_76484_3_, p_76484_4_ - 1, p_76484_5_, ForgeDirection.UP, (BlockSapling)Blocks.sapling) || block2 == EndPlus.blocks.enchGrass;
                boolean isSoil = (block2 == EndPlus.blocks.enchGrass || block2 == Blocks.grass || block2 == Blocks.dirt) && blockb == Blocks.air;
                if (isSoil && p_76484_4_ < 256 - l - 1)
                {
                            ...
                            for (int i2 = p_76484_5_ - k1; i2 <= p_76484_5_ + k1; ++i2)
                            {
                                ...
                                if (Math.abs(l1) != k1 || Math.abs(j2) != k1 || p_76484_2_.nextInt(2) != 0 && j1 != 0)
                                {
                                    ...
                                    if (block1.isAir(p_76484_1_, l2, k2, i2) || block1.isLeaves(p_76484_1_, l2, k2, i2))
                                    {
                                    	...
                                    	{
                                    	this.setBlockAndNotifyAdequately(p_76484_1_, l2, k2, i2, EndPlus.blocks.enchLeavesGen, 0);
                                    	}
                                    }
                                }
                            }
                    ...
                    for (k2 = 0; k2 < l; ++k2)
                    {
                        ...
                        if (true)//block3.isAir(p_76484_1_, p_76484_3_, p_76484_4_ + k2, p_76484_5_) || block3.isLeaves(p_76484_1_, p_76484_3_, p_76484_4_ + k2, p_76484_5_))
                        {
