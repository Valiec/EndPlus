...
public class EndPlusCommand extends CommandBase
{
    ...
    try
    {
        Minecraft.getMinecraft().thePlayer.addChatMessage(new ChatComponentText("You have EndPlus "+EndPlus.VERSION+". Newest release is EndPlus "+EndPlus.versionChecker.getNewestVersionNumber()+"."));
    }
