...
public class ChunkProviderNether256 implements IChunkProvider //INDEV 256 high Nether
{
    ...
    public ChunkProviderNether256(World par1World, long par2, Random par3)
    {
    ...
    public ChunkProviderNether256(World par1World, long par2)
    {
        this.worldObj = par1World;
        this.hellRNG = new Random();
        this.netherNoiseGen1 = new NoiseGeneratorOctaves(this.hellRNG, 16);
        this.netherNoiseGen2 = new NoiseGeneratorOctaves(this.hellRNG, 16);
        this.netherNoiseGen3 = new NoiseGeneratorOctaves(this.hellRNG, 8);
        this.slowsandGravelNoiseGen = new NoiseGeneratorOctaves(this.hellRNG, 4);
    ...
    public void func_147418_b(int p_147418_1_, int p_147418_2_, Block[] p_147418_3_)
    {
        ...
        //if (event.getResult() == Result.DENY) return; //do NOT push event to avoid infinite recursive loop
        ...
        for (int k = 0; k < 16; ++k)
        {
            for (int l = 0; l < 16; ++l)
            {
                ...
                for (int k1 = 255; k1 >= 0; --k1)
                {
                    ...
                    if(p_147418_3_[l1] == Blocks.netherrack)
                    {
                        int l2 = (l * 16 + k) * 128 + (k1+1);
                        int l3 = (l * 16 + k) * 128 + (k1-1);
                        if((p_147418_3_[l2] == null || p_147418_3_[l2].getMaterial() == Material.air) || (p_147418_3_[l3] == null || p_147418_3_[l3].getMaterial() == Material.air))
                        {
                            p_147418_3_[l1] = Blocks.bookshelf;
                        }
                        else
                        {
                            //System.out.println(p_147418_3_[l2].getMaterial());
                            p_147418_3_[l1] = EndPlus.blocks.netherStone;
                        }
                        if(k1>=128 && p_147418_3_[l1] == Blocks.bookshelf)
                        {
                            p_147418_3_[l1] = EndPlus.blocks.soulDirt; 
                        }
                        else if(k1<128 && p_147418_3_[l1] == Blocks.bookshelf)
                        {
                            p_147418_3_[l1] = Blocks.netherrack;
                        }
    ...
    double[] initializeNoiseField(double[] par1ArrayOfDouble, int par2, int par3, int par4, int par5, int par6, int par7)
    {
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        if (this.hellRNG.nextInt(1) == 0)
        {
            ...
            y1 = this.hellRNG.nextInt(64) + 64;
            l1 = l + this.hellRNG.nextInt(16) + 8;
            System.out.println(y1);
            System.out.println("Nether Wart");
            (new WorldGenNetherPlant()).generate(this.worldObj, this.hellRNG, j1, y1, l1);
        ...
        for (j1 = 0; j1 < i1; ++j1)
        {
            ...
            (new WorldGenNetherFire()).generate(this.worldObj, this.hellRNG, k1, l1, i2);
        }
        ...
        for (j1 = 0; j1 < i1; ++j1)
        {
            ...
            l1 = this.hellRNG.nextInt(120) + 4;
            i2 = l + this.hellRNG.nextInt(16) + 8;
            (new WorldGenGlowStoneOne()).generate(this.worldObj, this.hellRNG, k1, l1, i2);
        }
        ...
        for (j1 = 0; j1 < 10; ++j1)
        {
            ...
            i2 = l + this.hellRNG.nextInt(16) + 8;
            (new WorldGenGlowStoneTwo()).generate(this.worldObj, this.hellRNG, k1, l1, i2);
        }
        for (i1 = 0; i1 < 8; ++i1)
        {
            j1 = k + this.hellRNG.nextInt(16) + 8;
            ...
            l1 = l + this.hellRNG.nextInt(16) + 8;
            (new WorldGenNetherLava(Blocks.flowing_lava, false)).generate(this.worldObj, this.hellRNG, j1, k1, l1);
        }
        int j2;
        for (k1 = 0; k1 < 16; ++k1)
        {
            ...
            (new WorldGenNetherLava(Blocks.flowing_lava, true)).generate(this.worldObj, this.hellRNG, l1, i2, j2);
        }
