...
public class ChunkProviderEnder implements IChunkProvider
{
    ...
    public ChunkProviderEnder(World par1World, long par2)
    {
    ...
    {
        func_147421_b(p_147421_1_, p_147421_2_, p_147421_3_, null);
    }
    public void func_147421_b(int p_147421_1_, int p_147421_2_, Block[] p_147421_3_, BiomeGenBase[] p_147421_4_)
    {
        ...
        for (int k = 0; k < 16; ++k)
        {
            for (int l = 0; l < 16; ++l)
            {
                byte b0 = 1;
                int i1 = -1;
                Block block = EndPlus.blocks.endGrass;
                Block block1 = EndPlus.blocks.endDirt;
                ...
                for (int j1 = 127; j1 >= 0; --j1)
                {
                    ...
                    {
                        if (block2 == Blocks.stone || block2 == Blocks.end_stone)
                        {
                            if (i1 == -1)
                            {
                                if (b0 <= 0)
                    ...
                    {
                    	String createdby = "Val@iec20@19"; //remove the @ signs
                        ...
                        {
                            p_147421_3_[k1] = Blocks.bookshelf;
                        }
                        else
                        {
                        ...
                        {
                            p_147421_3_[k1] = EndPlus.blocks.soulDirt; 
                        }
                        else if(k1<64 && p_147421_3_[k1] == Blocks.bookshelf)
                        {
                            p_147421_3_[k1] = Blocks.netherrack;
                        }
