...
public class RenderHerobrine extends RenderBiped {
	...
	private static final ResourceLocation texture = new ResourceLocation("endplus:dragonfire/herobrine.png");
	/**
	 * @param par1ModelBiped
	 * @param par2
	 */
	public RenderHerobrine(ModelHerobrine par1ModelBiped, float par2) {
