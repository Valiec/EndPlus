...
public class WorldGenTreesModded extends WorldGenModdedTree
{
    /**
    ...
    public WorldGenTreesModded(boolean p_i2008_1_)
    {
        super(p_i2008_1_);
    }
    ...
    void func_150530_a(int[] p_150530_1_, int[] p_150530_2_, Block p_150530_3_)
    {
        ...
        if (aint2[b1] != 0)
        {
            ...
            for (int j = aint2[b1] + b4; i != j; i += b4)
            {
                ...
                this.setBlockAndNotifyAdequately(this.worldObj, aint3[0], aint3[1], aint3[2], Blocks.anvil, 0);//b5);
            }
        }
    }
    ...
    boolean validTreeLocation()
    {
        ...
        boolean isSoil = block.canSustainPlant(worldObj, basePos[0], basePos[1] - 1, basePos[2], ForgeDirection.UP, (BlockSapling)Blocks.sapling) || block == EndPlus.blocks.enchGrass;
        if (!isSoil)
        {
            return false;
        }
