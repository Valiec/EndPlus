...
public class ChunkProviderNether implements IChunkProvider
{
    ...
    public ChunkProviderNether(World par1World, long par2, Random par3)
    {
    ...
    public ChunkProviderNether(World par1World, long par2)
    {
        this.worldObj = par1World;
            ...
            for (int l = 0; l < 16; ++l)
            {
                ...
                for (int k1 = 127; k1 >= 0; --k1)
                {
                    ...
                    if(p_147418_3_[l1] == Blocks.netherrack)
                    {
                        ...
                        if(k1>=64 && p_147418_3_[l1] == Blocks.bookshelf)
                        {
                            p_147418_3_[l1] = EndPlus.blocks.soulDirt; 
                        }
                        else if(k1<64 && p_147418_3_[l1] == Blocks.bookshelf)
                        {
