...
public class BiomeModdedDecorator2 extends BiomeDecorator
{
    ...
    // JAVADOC FIELD $$ field_76813_b
    public Random randomGenerator;
    // JAVADOC FIELD $$ field_76814_c
    public int chunk_X;
    // JAVADOC FIELD $$ field_76811_d
    public int chunk_Z;
    // JAVADOC FIELD $$ field_76809_f
    public WorldGenerator clayGen = new WorldGenClay(4);
    // JAVADOC FIELD $$ field_76810_g
    public WorldGenerator sandGen;
    // JAVADOC FIELD $$ field_76822_h
    public WorldGenerator gravelAsSandGen;
    // JAVADOC FIELD $$ field_76823_i
    public WorldGenerator dirtGen;
    public WorldGenerator gravelGen;
    public WorldGenerator coalGen;
    public WorldGenerator ironGen;
    // JAVADOC FIELD $$ field_76819_m
    public WorldGenerator goldGen;
    // JAVADOC FIELD $$ field_76816_n
    public WorldGenerator redstoneGen;
    // JAVADOC FIELD $$ field_76817_o
    public WorldGenerator diamondGen;
    // JAVADOC FIELD $$ field_76831_p
    public WorldGenerator lapisGen;
    public WorldGenFlowers yellowFlowerGen;
    // JAVADOC FIELD $$ field_76828_s
    public WorldGenerator mushroomBrownGen;
    // JAVADOC FIELD $$ field_76827_t
    public WorldGenerator mushroomRedGen;
    // JAVADOC FIELD $$ field_76826_u
    public WorldGenerator bigMushroomGen;
    // JAVADOC FIELD $$ field_76825_v
    public WorldGenerator reedGen;
    // JAVADOC FIELD $$ field_76824_w
    public WorldGenerator cactusGen;
    // JAVADOC FIELD $$ field_76834_x
    public WorldGenerator waterlilyGen;
    // JAVADOC FIELD $$ field_76833_y
    public int waterlilyPerChunk;
    // JAVADOC FIELD $$ field_76832_z
    public int treesPerChunk;
    // JAVADOC FIELD $$ field_76802_A
    public int flowersPerChunk;
    // JAVADOC FIELD $$ field_76803_B
    public int grassPerChunk;
    // JAVADOC FIELD $$ field_76804_C
    public int deadBushPerChunk;
    // JAVADOC FIELD $$ field_76798_D
    public int mushroomsPerChunk;
    // JAVADOC FIELD $$ field_76799_E
    public int reedsPerChunk;
    // JAVADOC FIELD $$ field_76800_F
    public int cactiPerChunk;
    // JAVADOC FIELD $$ field_76801_G
    public int sandPerChunk;
    // JAVADOC FIELD $$ field_76805_H
    public int sandPerChunk2;
    // JAVADOC FIELD $$ field_76806_I
    public int clayPerChunk;
    // JAVADOC FIELD $$ field_76807_J
    public int bigMushroomsPerChunk;
    // JAVADOC FIELD $$ field_76808_K
    ...
    protected void genDecorations(BiomeGenBase p_150513_1_)
    {
        ...
        for (j = 0; doGen && j < this.grassPerChunk; ++j)
        {
            k = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
            l = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
            i1 = this.randomGenerator.nextInt(this.currentWorld.getHeightValue(k, l) * 2+1);
        ...
        for (j = 0; doGen && j < this.waterlilyPerChunk; ++j)
        {
            ...
            for (i1 = this.randomGenerator.nextInt(this.currentWorld.getHeightValue(k, l) * 2+1); i1 > 0 && this.currentWorld.isAirBlock(k, i1 - 1, l); --i1)
            {
                ;
            }
        ...
        if (doGen && this.randomGenerator.nextInt(4) == 0)
        {
            j = this.chunk_X + this.randomGenerator.nextInt(16) + 8;
            k = this.chunk_Z + this.randomGenerator.nextInt(16) + 8;
            l = this.randomGenerator.nextInt(this.currentWorld.getHeightValue(j, k) * 2+1);
