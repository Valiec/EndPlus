...
public class WorldGenBigTreeModded extends WorldGenModdedTree
{
    /**
    ...
    public WorldGenBigTreeModded(boolean p_i2008_1_)
    {
        super(p_i2008_1_);
    }
    ...
    {
        this.height = (int)((double)this.heightLimit * this.heightAttenuation)+5;

        if (this.height >= this.heightLimit)
        {
            this.height = this.heightLimit - 2;
        }
    ...
    void generateLeafNode(int p_76491_1_, int p_76491_2_, int p_76491_3_)
    {
        ...
        for (int i1 = p_76491_2_ + this.leafDistanceLimit; l < i1; ++l)
        {
            ...
            this.func_150529_a(p_76491_1_, l, p_76491_3_, f, (byte)1, EndPlus.blocks.enchLeavesGen);
        }
    }
